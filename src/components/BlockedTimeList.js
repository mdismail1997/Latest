...
export default class BlockedTimeList extends React.PureComponent {
    state = {
    ...
    scrollTo = () => {
        ...
        setTimeout(function() {
            _this.refs.sectionAppointment.scrollToLocation({
                animated: true,
                ...
                <View style={styles.sectionheader}>
                    ...
                    { this.isAdd
                     && 
                        ...
                        >
                            + {getTextByKey(this.props.language,'addblockedtime')}
                        </Text>
                    }                        
