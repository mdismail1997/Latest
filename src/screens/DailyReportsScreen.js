...
export default class DailyReportsScreen extends React.Component {
    ...
    render() {
        // console.log(setting.technicianSaleReportsUrl + '?type=Daily&idtech='+this.idtech+'&height='+height);
            ...
            return (
                <View style={styles.container}>
                    <WebView
                        ...
                        source={{
                            uri: setting.technicianSaleReportsUrl + '?type=Daily&idtech='+this.idtech+'&height='+height,
