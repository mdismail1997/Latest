...
export default class CalendarStrip extends Component {
    ...
    static propTypes = {
		...
		dateNumberStyleText: PropTypes.any,
		...
		highlightDateNumberStyleText : PropTypes.any,
    ...
    constructor(props) {
        ...
        this.UNSAFE_componentDidMount = this.UNSAFE_componentDidMount.bind(this);
    ...
    isDateSelected(date) {		
		//console.log(date.format('YMD'));console.log(this.state.selectedDate.format('YMD'));
		//console.log(date.format('YMD') == this.state.selectedDate.format('YMD'));
		//return date.format('YMD') == this.state.selectedDate.format('YMD');
        //console.log(date.isSame(this.state.selectedDate, 'day'));
        //console.log(this.state.selectedDate.format('YYYY-MM-DD HH:mm'));
        /*
        if(date.isSame(this.state.selectedDate, 'day')){
            console.log(this.state.selectedDate.format('YYYY-MM-DD HH:mm'));
    ...
    render() {
            ...
            return (
                <Animated.View key={index} style={{opacity: opacityAnim, flex: 1}}>
                    <CalendarDay
						...
						dateNumberStyleText={this.props.dateNumberStyleText}
						...
						highlightDateNumberStyleText = {this.props.highlightDateNumberStyleText}
		...
		if(this.props.calendarHeader)
		{
			calendarHeader = this.props.calendarHeader(this.formatCalendarHeader());
		}
