...
export default class EditClient extends React.Component{
    ...
    _keyboardDidHide () {
        ...
        // this.setState({heightScrollView:"100%"});
    }

    setData = (data) => {
        this.clientData = data;
        this.state.email = data.email == null ? '' : data.email;
    ...
    onFocus = (refname) => {
        // this.setState({heightScrollView:200});
    ...
    render() {     
        ...
        return (
            <ScrollView style={[styles.container]} ref='scrolleditcustomer'>
                <View style={{flex: 1, flexDirection: 'row'}}> 
                    <Text style={styles.clientTitle}>Update Information 1</Text>
                    <TouchableOpacity
                        activeOpacity={1}
                ...
                <View style={{justifyContent: 'flex-end', alignItems: 'flex-end', marginBottom: 0, zIndex:-1}}>
